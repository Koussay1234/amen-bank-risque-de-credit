...
║     Version 4.0 PROFESSIONAL — Amen Bank Tunisie                     ║
    ...
    with col:
        ...
        if st.button("🔐  Se connecter", use_container_width=True):
            if check_password(username, password):
                ...
                st.session_state.login_error="❌ Identifiant ou mot de passe incorrect."; st.rerun()
        st.markdown(f"""
        <div style="background:{VERT_BG};border-radius:8px;padding:.7rem 1rem;font-size:.72rem;color:{VERT_DARK};text-align:center;margin-top:1rem;border:1px solid {VERT_C}44">
          💡 Demo : <b>koussay</b>/koussay2004 &nbsp;·&nbsp; <b>analyste</b>/credit123 &nbsp;·&nbsp; <b>directeur</b>/dir2024
        </div>""", unsafe_allow_html=True)
